...
<head>
    ...
    <title>Actualité-Paroisse Notre Dame de l'Annonciation </title>
    <!---boostrap css--->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary ">
        <div class="container">
            <a class="navbar-brand" href="../index.php"><img src="../images/Oribat.png" alt="image" height="42"
                    width="42">Paroisse
                Notre
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav m-auto mb-2 mb-lg-0 text-end">
                    <li class="nav-item mx-2 ">
                        <a class="nav-link active" aria-current="page" href="../index.php" id="acceuil">Acceuil</a>
                    </li>
                    <li class="nav-item mx-2">
                        <a class="nav-link" href="#" style="color:var(--bs-blue)">Actualité</a>
                    </li>
                    <li class="nav-item mx-2">
                        <a class="nav-link" href="../index.php#Horaire">horaire</a>
                    </li>
    ...
    <Div class="center" style="width:60%;margin-left:auto;margin-right:auto; " ><br><br><br>
        <h1>Actualité</h1><br><br><br>
        <div class="tout_actu" style="display: flex; flex-wrap: wrap; align-content: space-around;"data-aos="fade-right">
            <?php
            include_once('datab.php');
                        ...
                        <div class="our_two_box">
                            <div class="row d_flex">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                    <div class="our_img">
                                        <figure><img src="/Paroisse Notre Dame de L'annonciation/admin/app/images/<?php echo $rep->image_name; ?>"></figure>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
    ...
    <footer class="text-center text-lg-start bg-primary text-white pt-4">
        ...
        <!-- Copyright -->
        <div class="text-center p-4"> Developpé par <a href="https://first-agency-ci.netlify.app/"
                style="color: #ffff5f!important"> FIRST AGENCY</a>
